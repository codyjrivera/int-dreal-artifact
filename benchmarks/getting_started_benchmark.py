...
#
# Benchmarking script for running ∫dReal on Table 3 benchmarks.
# The 'getting started' script omits all benchmarks taking >1 minute,
# to ensure the entire process takes ~5 min.
...
benchmarks = [
    ...
    # Second region: 2-deep nested integrals
    'eth_colrank_fair_00',
    'eth_colrank_unfair_00',
    'vol_cmp_00',
    'vol_cmp_01',
    'vol_cmp_02',
    'vol_cmp_03',
    ...
    'gauss_mech_00',
    #'eth_colrank_fair_01',
    'eth_colrank_unfair_01',

    # Third region: 3-deep nested integrals
    'svt_gauss_00',
    #'svt_gauss_sat_00',

    # Fourth region: quantifier alternation
    #'gauss_forall_00',
    'vol_cmp_00_forall',
    'vol_cmp_02_forall',
    'vol_cmp_04_forall',
...
benchmark_path = os.path.join(os.getcwd(), 'int-dreal')
...
with open(output_path + '/getting_started_results.csv', 'w', newline='') as outfile:
