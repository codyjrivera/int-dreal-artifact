...
# Benchmark list
benchmarks = ["num_integrals/scale_integrals_var_" + str(k) for k in range(1, 100)] \
            + ["num_integrals_nested/scale_integrals_nested_var_" + str(k) for k in range(1, 100)]
...
with open(output_path + '/figure_6_results.csv', 'w', newline='') as outfile:
