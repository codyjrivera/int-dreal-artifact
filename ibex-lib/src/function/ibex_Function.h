...
public:
	...
	/*
	 * \brief Get a reference to the integral evaluator.
	 *
	 * For internal purposes.
	 */
	IntegralEval& integral_evaluator() const;
...
inline IntegralEval& Function::integral_evaluator() const {
	return *_integraleval;
}
