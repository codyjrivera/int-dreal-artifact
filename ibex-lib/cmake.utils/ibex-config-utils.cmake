...
################################################################################
################################################################################
function (LIB_GET_ABSPATH_FROM_NAME_TYPE var libdir libname is_shared)
  if (is_shared)
    set (_pre ${CMAKE_SHARED_LIBRARY_PREFIX})
    set (_suf ${CMAKE_SHARED_LIBRARY_SUFFIX})
  else ()
...
function (CREATE_TARGET_IMPORT_AND_EXPORT libname libabspath cfgfilename_var)
  ...
  if (CTIE_INSTALL)
    ...
    file (GLOB _libdeps "${libabspath}*")
    install (FILES ${_libdeps}
             DESTINATION ${CMAKE_INSTALL_LIBDIR_3RD} ${_cn})
    if (libtype STREQUAL "SHARED")
      install (CODE "execute_process(COMMAND /sbin/ldconfig ${prefix}/${CMAKE_INSTALL_LIBDIR_3RD})")
    endif ()
