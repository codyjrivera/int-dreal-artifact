...
class ExpressionIntegral;               // In symbolic_expression_cell.h
...
class Expression {
 public:
  ...
  friend Expression integral(const Variable& var, 
                             const Expression& a,
                             const Expression& b,
  ...
  friend bool is_integral(const Expression& e);
  ...
  friend const ExpressionUninterpretedFunction* to_uninterpreted_function(
      const Expression& e);
  friend const ExpressionIntegral* to_integral(const Expression& e);
...
Expression uninterpreted_function(const std::string& name,
                                  const Variables& vars);
Expression integral(const Variable& var, 
                    const Expression& a,
                    const Expression& b,
                    const Expression& integrand);
...
/** Checks if @p e is an integral expression. */
bool is_integral(const Expression& e);
...
/** Returns the variable of integration of an integral @p e.
 *  @pre @p e is an integral expression.
 */
const Variable& get_integration_var(const Expression& e);

/** Returns the left endpoint of integration of an integral @p e.
 *  @pre @p e is an integral expression.
 */
const Expression& get_left_endpoint(const Expression& e);

/** Returns the right endpoint of integration of an integral @p e.
 *  @pre @p e is an integral expression.
 */
const Expression& get_right_endpoint(const Expression& e);

/** Returns the integrand an integral @p e.
 *  @pre @p e is an integral expression.
 */
const Expression& get_integrand(const Expression& e);
