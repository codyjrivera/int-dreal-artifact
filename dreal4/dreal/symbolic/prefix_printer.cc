...
ostream& PrefixPrinter::VisitIntegral(const Expression& e) {
  os_ << "(integral ";
  Print(get_left_endpoint(e));
  os_ << " ";
  Print(get_right_endpoint(e));
  os_ << " (lambda (";
  Print(get_integration_var(e));
  os_ << ") ";
  Print(get_integrand(e));
  return os_ << "))";
}
