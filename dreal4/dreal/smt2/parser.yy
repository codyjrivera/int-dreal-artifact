...
term:           TK_TRUE { $$ = Formula::True(); }
        ...
        |      '(' TK_INTEGRAL term term '(' TK_LAMBDA enter_scope variable_sort term exit_scope ')' ')' {
            $$ = integral(std::get<0>($8), $3.expression(), $4.expression(), $9.expression());
            }
       |       '(' SYMBOL term_list ')' {
